...
/**
 * FullName is a class that implements the Comparable interface so that any
 * FullName object can compare itself to another FullName object.
 *  
 * If we're implementing an interface, we need to implement all of the abstract
...
public class FullName implements Comparable<FullName> {
    ...
    // constructors
    /**
     * Default constructor for the FullName class.  It chooses a random first
     * name and a random last name from a list of 20 possibilities.
     * 
     * @return void
     * 
     */
    ...
    /**
     * Constructor for the FullName class that takes a first name and a last
     * name as parameters.
     * @param firstName
     * @param lastName
     */
